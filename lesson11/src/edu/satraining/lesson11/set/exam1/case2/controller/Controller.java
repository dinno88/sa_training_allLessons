package edu.satraining.lesson11.set.exam1.case2.controller;

import edu.satraining.lesson11.set.exam1.case2.model.Book;
...
public class Controller {
    ...
    public void editData() {
        ...
        String isbnToEdit = scanner1.nextLine();
        ...
        if (bookIndex != -1) {
            ...
            for (Book book : books) {
                if (book.getIsbn().equals(isbnToEdit)) {
                    oldBook = book;
                    bookToUpdate = book.clone(); // Create a clone of the old book to store the original data
                    break;
                }
            }
            ...
            if (bookToUpdate != null) {
                ...
                System.out.printf("Penerbit      : ");
                String newPublisher = scanner1.nextLine();
                bookToUpdate.setPublisher(newPublisher);

                System.out.printf("Harga         : ");
                float newPrice = Float.parseFloat(scanner1.nextLine());
                bookToUpdate.setPrice(newPrice);

                System.out.printf("Jumlah Halaman: ");
                int newPage = Integer.parseInt(scanner1.nextLine());
                ...
                // Update the set of books with the new data
    ...
    String isbnToDelete = scanner1.nextLine();
